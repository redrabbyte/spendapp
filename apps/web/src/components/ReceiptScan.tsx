  ...
  return (
    <>
      <button
        ...
        // Deliberately tight: this has to share a line with the amount and the
        // unit on a narrow handset, and it is the widest of the three.
        className="flex items-center gap-1 rounded border border-slate-300 px-1.5 py-2 text-sm font-medium text-slate-600 dark:border-slate-600 dark:text-slate-300"
      >
